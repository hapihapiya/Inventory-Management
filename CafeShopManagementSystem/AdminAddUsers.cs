                    ...
                    try
                    {
                        ...
                        using (SqlCommand checkUsern = new SqlCommand(selectUsern, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string relativePath = Path.Combine(@"C:\Users\user\source\repos\CafeShopManagementSystem\CafeShopManagementSystem\Product_Directory\" , 
                    ...
                    if (connect.State != ConnectionState.Open)
                    {
                        try
                        {
                            ...
                            using (SqlCommand cmd = new SqlCommand(updateData, connect))
                            {
                                ...
                                if (string.IsNullOrEmpty(adminAddUsers_imageView.ImageLocation))
                                {
                                    MessageBox.Show("No image selected. Please select an image.", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                    return;
                                }
